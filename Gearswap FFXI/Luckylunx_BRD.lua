...
function init_gear_sets()
	...
	sets.precast.FC["Valor Minuet V"] = set_combine(sets.precast.FC.BardSong,{range="Terpander"})
    sets.precast.FC["Valor Minuet IV"] = set_combine(sets.precast.FC.BardSong,{range="Terpander"})
	sets.precast.FC["Blade Madrigal"] = set_combine(sets.precast.FC.BardSong,{range="Terpander"})
    ...
    sets.midcast.Madrigal = {range="Terpander", head="Fili calot +1",left_ear="Kuwunga Earring",}
    sets.midcast.March = {hands="Fili Manchettes +1"}
    sets.midcast.Minuet = {range="Terpander", body="Fili Hongreline +1"}
    ...
    sets.midcast['Magic Finale'] = {neck="Moonbow Whistle +1",waist="Eschan stone",legs="Fili Rhingrave +1"}
    ...
    sets.midcast.SongRecast = {ear2="Loquacious Earring",
        ...
        back="Intarabus's cape",waist="Corvax Sash",legs="Fili Rhingrave +1"}
    ...
    sets.Kiting = {legs="Fili Cothurnes +1"}
...
function calculate_duration(spellName, spellMap)
    ...
    if player.equipment.legs == "Fili Rhingrave +1" then mult = mult + 0.1 end
